      ...
      <div className="relative hidden lg:flex lg:w-1/2 items-center justify-center bg-gradient-to-br from-teal-500 via-blue-600 to-indigo-700 p-12 overflow-hidden">
        ...
        >
          ...
          <div className="bg-white/15 border border-white/20 rounded-xl p-8 shadow-2xl backdrop-blur-lg">
            <h3 className="text-xl font-semibold text-white">Empower Your Finances</h3>
            <p className="mt-3 text-sm text-teal-100/90">
              Seamlessly track, analyze, and plan your financial future with our intuitive platform.
            </p>
        ...
        >
          <div className="text-sm uppercase tracking-wider text-teal-100/80">Portfolio Value</div>
          <div className="text-3xl font-bold">$12,450</div>
          <div className="text-sm text-teal-100/70">Current net worth</div>
        </motion.div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-16 bg-gray-50 dark:bg-gray-900">
        ...
        >
          ...
          <div className="text-center space-y-3">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Welcome to BudgetBuddy</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Sign in to manage your finances with precision and ease.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            <Link
              to="/register"
              className="flex-1 py-3 rounded-lg bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400 hover:bg-teal-100 dark:hover:bg-teal-900/30 text-center font-medium transition"
            >
              Create Account
            </Link>
          </div>
          ...
          <div className="text-center text-xs text-gray-400">
            ...
            <Link to="/terms" className="underline hover:text-teal-500">
              Terms
            </Link>{' '}
            &{' '}
            <Link to="/privacy" className="underline hover:text-teal-500">
              Privacy
            </Link>
            .
          </div>
